...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Talk.duration'
        db.alter_column('talks_talk', 'duration', self.gf('django.db.models.fields.TimeField')())
    ...
    models = {
        ...
        'talks.talkfeature': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 8, 12, 19, 16, 52, 514053)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
